...
conf = visier.api.permission_management.Configuration(
    ...
    def __init__(self,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("visier.api.permission_management")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 22222222.99201.1389\n"\
...
def _update_access_token(config, token_request: TokenRequestDTO):
    ...
    config.token_expiration_secs = int(response_json.get('expires_in'))
