    ...
    def make_instance(self, include_optional) -> DataSecurityProfileDTO:
        ...
        if include_optional:
            return DataSecurityProfileDTO(
                ...
                inherited_reference_member_filter_config = visier.api.permission_management.models.inherited_reference_member_filter_config_dto.InheritedReferenceMemberFilterConfigDTO(
                ...
                property_set_config = visier.api.permission_management.models.property_set_config_dto.PropertySetConfigDTO(
