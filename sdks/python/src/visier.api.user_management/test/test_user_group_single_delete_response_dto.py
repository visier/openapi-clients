    ...
    def make_instance(self, include_optional) -> UserGroupSingleDeleteResponseDTO:
        ...
        if include_optional:
            return UserGroupSingleDeleteResponseDTO(
                failure = visier.api.user_management.models.user_group_delete_failure_dto.UserGroupDeleteFailureDTO(
                    message = '', 
                    rci = '', 
                    tenant_code = '', 
                    user_group_id = '', ),
                success = visier.api.user_management.models.user_group_delete_success_dto.UserGroupDeleteSuccessDTO(
                    tenant_code = '', 
                    user_group_id = '', )
            )
        else:
