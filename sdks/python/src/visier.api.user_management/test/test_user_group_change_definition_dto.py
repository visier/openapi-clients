    ...
    def make_instance(self, include_optional) -> UserGroupChangeDefinitionDTO:
        ...
        if include_optional:
            return UserGroupChangeDefinitionDTO(
                description = '',
                display_name = '',
                permission_ids = visier.api.user_management.models.element_ids_dto.ElementIDsDTO(
                    ids = [
                        ''
                        ], ),
                tenant_code = '',
                user_group_id = '',
                users = visier.api.user_management.models.user_group_change_users_dto.UserGroupChangeUsersDTO(
