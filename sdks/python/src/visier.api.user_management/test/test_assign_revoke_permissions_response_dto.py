    ...
    def make_instance(self, include_optional) -> AssignRevokePermissionsResponseDTO:
        ...
        if include_optional:
            return AssignRevokePermissionsResponseDTO(
                tenants = [
                    visier.api.user_management.models.assign_revoke_permission_by_tenant_dto.AssignRevokePermissionByTenantDTO(
                        message = '', 
                        permissions = [
                            visier.api.user_management.models.assign_revoke_permission_by_permission_dto.AssignRevokePermissionByPermissionDTO(
                                permission = visier.api.user_management.models.permission_assigned_for_local_tenant_dto.PermissionAssignedForLocalTenantDTO(
                                    description = '', 
                                    display_name = '', 
                                    permission_id = '', ), 
                                users = [
                                    visier.api.user_management.models.assign_revoke_permission_by_user_dto.AssignRevokePermissionByUserDTO(
                                        message = '', 
                                        user_id = '', 
                                        username = '', )
                                    ], )
