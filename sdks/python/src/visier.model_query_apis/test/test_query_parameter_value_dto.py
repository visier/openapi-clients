    ...
    def make_instance(self, include_optional) -> QueryParameterValueDTO:
        ...
        if include_optional:
            return QueryParameterValueDTO(
                aggregation_type_value = visier.model_query_apis.models.aggregation_type_parameter_value_dto.AggregationTypeParameterValueDTO(
                    aggregation_option_id = '', 
                    parameter_id = '', ),
                member_value = visier.model_query_apis.models.member_parameter_value_dto.MemberParameterValueDTO(
                    dimension_id = '', 
                    parameter_id = '', 
                    reference_path = [
                        ''
                    ...
                    values = null, ),
                numeric_value = visier.model_query_apis.models.numeric_parameter_value_dto.NumericParameterValueDTO(
                    parameter_id = '', 
                    value = 1.337, ),
                plan_value = visier.model_query_apis.models.plan_parameter_value_dto.PlanParameterValueDTO(
                    parameter_id = '', 
                    plan_id = '', 
                    scenario_id = '', 
                    snapshot_id = '', )
