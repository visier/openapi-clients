    ...
    def make_instance(self, include_optional) -> AggregationQueryExecutionDTO:
        ...
        if include_optional:
            return AggregationQueryExecutionDTO(
                options = visier.model_query_apis.models.query_execution_options_dto.QueryExecutionOptionsDTO(
                    axis_visibility = 'SIMPLE', 
                    calendar_type = 'TENANT_CALENDAR', 
                    cell_distribution_options = visier.model_query_apis.models.cell_distribution_options_dto.CellDistributionOptionsDTO(
                        bin_count = 56, ), 
                    ...
                    internal = visier.model_query_apis.models.internal_query_execution_options_dto.InternalQueryExecutionOptionsDTO(
                ...
                query = visier.model_query_apis.models.aggregation_query_dto.AggregationQueryDTO(
                    axes = [
                        visier.model_query_apis.models.query_axis_dto.QueryAxisDTO(
