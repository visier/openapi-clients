...
class TestCellSetDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CellSetDTO:
        ...
        if include_optional:
            return CellSetDTO(
                axes = [
                    visier.model_query_apis.models.cell_set_axis_dto.CellSetAxisDTO(
                        dimension = null, 
                        positions = [
                            visier.model_query_apis.models.cell_set_axis_position_dto.CellSetAxisPositionDTO(
                                display_name = '', 
                                display_name_path = [
                                    ''
                                    ], 
                ...
                cells = [
                    visier.model_query_apis.models.cell_dto.CellDTO(
                        coordinates = [
                            56
                            ], 
                        distribution = [
                            visier.model_query_apis.models.cell_distribution_bin_dto.CellDistributionBinDTO(
                                support = '', 
                                value = '', )
                            ], 
                        support = '', 
                ...
                lineage = visier.model_query_apis.models.lineage_dto.LineageDTO(
                    cell_sets = [
                        visier.model_query_apis.models.cell_set_dto.CellSetDTO(
                            axes = [
                                visier.model_query_apis.models.cell_set_axis_dto.CellSetAxisDTO(
                                    dimension = null, 
                                    positions = [
