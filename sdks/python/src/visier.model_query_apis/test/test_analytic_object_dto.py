    ...
    def make_instance(self, include_optional) -> AnalyticObjectDTO:
        ...
        if include_optional:
            return AnalyticObjectDTO(
                ...
                id = '',
                object_references = [
                    visier.model_query_apis.models.object_reference_dto.ObjectReferenceDTO(
                        description = '', 
                        display_name = '', 
                        from_object = '', 
                        id = '', 
                ...
                population_configuration = visier.model_query_apis.models.population_configuration_dto.PopulationConfigurationDTO(
                    change_history_properties = [
                        visier.model_query_apis.models.property_reference_dto.PropertyReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], 
                    ...
                    grouping_dimensions = [
                        visier.model_query_apis.models.dimension_reference_dto.DimensionReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], ),
                property_ids = [
