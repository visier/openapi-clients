    ...
    def make_instance(self, include_optional) -> QueryPropertyDTO:
        ...
        if include_optional:
            return QueryPropertyDTO(
                ...
                formula = '',
                member_map_property = visier.model_query_apis.models.query_member_map_property_dto.QueryMemberMapPropertyDTO(
                    member_map = null, 
                    target_dimension_name = '', ),
                var_property = visier.model_query_apis.models.property_reference_dto.PropertyReferenceDTO(
                    name = '', 
                    qualifying_path = '', ),
