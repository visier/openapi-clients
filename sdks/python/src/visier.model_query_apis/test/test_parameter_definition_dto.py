    ...
    def make_instance(self, include_optional) -> ParameterDefinitionDTO:
        ...
        if include_optional:
            return ParameterDefinitionDTO(
                aggregation_type_parameter = visier.model_query_apis.models.aggregation_type_parameter_dto.AggregationTypeParameterDTO(
                    description = '', 
                    display_name = '', 
                    id = '', 
                    parameter_options = [
                        visier.model_query_apis.models.aggregation_type_option_dto.AggregationTypeOptionDTO(
                ...
                member_parameter = visier.model_query_apis.models.member_parameter_definition_dto.MemberParameterDefinitionDTO(
                    default = null, 
                    description = '', 
                    dimension_id = '', 
                    display_name = '', 
                ...
                numeric_parameter = visier.model_query_apis.models.numeric_parameter_definition_dto.NumericParameterDefinitionDTO(
                    default = 1.337, 
                    description = '', 
                    display_name = '', 
                    id = '', 
                    lower_bound = 1.337, 
                    upper_bound = 1.337, ),
                plan_parameter = visier.model_query_apis.models.plan_parameter_definition_dto.PlanParameterDefinitionDTO(
                    description = '', 
                    display_name = '', 
                    id = '', 
                    model_name = '', )
