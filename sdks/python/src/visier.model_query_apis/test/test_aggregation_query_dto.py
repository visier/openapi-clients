    ...
    def make_instance(self, include_optional) -> AggregationQueryDTO:
        ...
        if include_optional:
            return AggregationQueryDTO(
                ...
                source = visier.model_query_apis.models.aggregation_query_source_dto.AggregationQuerySourceDTO(
                    formula = '', 
                    metric = '', 
                    metrics = null, ),
                time_intervals = visier.model_query_apis.models.query_time_intervals_dto.QueryTimeIntervalsDTO(
                    direction = 'BACKWARD', 
                    dynamic_date_from = '', 
                    from_date_time = '', 
                    from_instant = '', 
