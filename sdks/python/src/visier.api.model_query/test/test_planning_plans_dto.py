    ...
    def make_instance(self, include_optional) -> PlanningPlansDTO:
        ...
        if include_optional:
            return PlanningPlansDTO(
                plans = [
                    visier.api.model_query.models.planning_plan_dto.PlanningPlanDTO(
                        default_contexts = [
                            visier.api.model_query.models.planning_plan_context_dto.PlanningPlanContextDTO(
                        ...
                        scenarios = [
                            visier.api.model_query.models.scenario_or_snapshot_dto.ScenarioOrSnapshotDTO(
                                display_name = '', 
                                id = '', )
                            ], 
                        snapshots = [
