    ...
    def make_instance(self, include_optional) -> AggregationQuerySourceDTO:
        ...
        if include_optional:
            return AggregationQuerySourceDTO(
                formula = '',
                metric = '',
                metrics = visier.api.model_query.models.aggregation_query_source_metrics_dto.AggregationQuerySourceMetricsDTO(
                    columns = [
                        visier.api.model_query.models.aggregation_query_source_metric_dto.AggregationQuerySourceMetricDTO(
                            column_name = '', 
                            formula = '', 
                            id = '', 
                            qualifying_path = '', )
