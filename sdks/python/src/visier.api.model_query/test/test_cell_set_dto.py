...
class TestCellSetDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CellSetDTO:
        ...
        if include_optional:
            return CellSetDTO(
                axes = [
                    visier.api.model_query.models.cell_set_axis_dto.CellSetAxisDTO(
                        dimension = null, 
                        positions = [
                            visier.api.model_query.models.cell_set_axis_position_dto.CellSetAxisPositionDTO(
                                display_name = '', 
                                display_name_path = [
                                    ''
                                    ], 
                ...
                cells = [
                    visier.api.model_query.models.cell_dto.CellDTO(
                        coordinates = [
                            56
                            ], 
                        distribution = [
                            visier.api.model_query.models.cell_distribution_bin_dto.CellDistributionBinDTO(
                                support = '', 
                                value = '', )
                            ], 
                        support = '', 
                ...
                lineage = visier.api.model_query.models.lineage_dto.LineageDTO(
                    cell_sets = [
                        visier.api.model_query.models.cell_set_dto.CellSetDTO(
                            axes = [
                                visier.api.model_query.models.cell_set_axis_dto.CellSetAxisDTO(
                                    dimension = null, 
                                    positions = [
