    ...
    def make_instance(self, include_optional) -> AggregationQueryExecutionDTO:
        ...
        if include_optional:
            return AggregationQueryExecutionDTO(
                options = visier.api.model_query.models.query_execution_options_dto.QueryExecutionOptionsDTO(
                ...
                query = visier.api.model_query.models.aggregation_query_dto.AggregationQueryDTO(
                    axes = [
