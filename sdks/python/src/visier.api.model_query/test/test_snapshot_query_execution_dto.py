    ...
    def make_instance(self, include_optional) -> SnapshotQueryExecutionDTO:
        ...
        if include_optional:
            return SnapshotQueryExecutionDTO(
                columns = [
                    visier.api.model_query.models.property_column_dto.PropertyColumnDTO(
                        column_definition = null, 
                        column_name = '', )
                    ],
                filters = [
                    visier.api.model_query.models.query_filter_dto.QueryFilterDTO(
                        cohort = null, 
                        formula = '', 
                        member_set = null, 
                        selection_concept = null, )
                    ],
                options = visier.api.model_query.models.snapshot_query_execution_options_dto.SnapshotQueryExecutionOptionsDTO(
                    ...
                    query_mode = 'DEFAULT', ),
                parameter_values = [
                    visier.api.model_query.models.query_parameter_value_dto.QueryParameterValueDTO(
                ...
                sort_options = [
                    visier.api.model_query.models.sort_option_dto.SortOptionDTO(
                        column_index = 56, 
                        sort_direction = 'SORT_ASCENDING', )
                    ],
                source = visier.api.model_query.models.list_query_source_dto.ListQuerySourceDTO(
                    analytic_object = '', 
                    formula = '', 
                    metric = '', ),
                time_intervals = visier.api.model_query.models.query_time_intervals_dto.QueryTimeIntervalsDTO(
                    direction = 'BACKWARD', 
                    dynamic_date_from = '', 
                    from_date_time = '', 
                    from_instant = '', 
