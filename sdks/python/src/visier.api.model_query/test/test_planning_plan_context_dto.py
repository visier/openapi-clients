    ...
    def make_instance(self, include_optional) -> PlanningPlanContextDTO:
        ...
        if include_optional:
            return PlanningPlanContextDTO(
                concept_filter_context = visier.api.model_query.models.planning_concept_filter_context_dto.PlanningConceptFilterContextDTO(
                    name = '', ),
                hierarchy_filter_context = visier.api.model_query.models.planning_hierarchy_filter_context_dto.PlanningHierarchyFilterContextDTO(
                    excluded_members = [
                        ''
                        ], 
                    hierarchy_name = '', 
