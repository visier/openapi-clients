    ...
    def make_instance(self, include_optional) -> QueryPropertyDTO:
        ...
        if include_optional:
            return QueryPropertyDTO(
                dimension = visier.api.model_query.models.dimension_reference_dto.DimensionReferenceDTO(
                    name = '', 
                    qualifying_path = '', ),
                effective_date_property = None,
                formula = '',
                member_map_property = visier.api.model_query.models.query_member_map_property_dto.QueryMemberMapPropertyDTO(
                    member_map = null, 
                    target_dimension_name = '', ),
                var_property = visier.api.model_query.models.property_reference_dto.PropertyReferenceDTO(
                    name = '', 
                    qualifying_path = '', ),
