    ...
    def make_instance(self, include_optional) -> PropertiesDTO:
        ...
        if include_optional:
            return PropertiesDTO(
                properties = [
                    visier.api.model_query.models.property_dto.PropertyDTO(
                        data_type = '', 
                        description = '', 
                        display_name = '', 
                        id = '', 
                        parameters = [
                            visier.api.model_query.models.parameter_definition_dto.ParameterDefinitionDTO(
                        ...
                        primitive_data_type = '', 
                        tags = [
                            visier.api.model_query.models.tag_map_element_dto.TagMapElementDTO(
                                display_name = '', 
                                id = '', )
                            ], )
                    ]
