    ...
    def make_instance(self, include_optional) -> CohortFilterDTO:
        ...
        if include_optional:
            return CohortFilterDTO(
                exclude = True,
                key_group = visier.api.model_query.models.key_group_filter_dto.KeyGroupFilterDTO(
                    filters = [
                        visier.api.model_query.models.key_group_filter_item_dto.KeyGroupFilterItemDTO(
                            formula = '', 
                            member_set = null, 
