    ...
    def make_instance(self, include_optional) -> AnalyticObjectDTO:
        ...
        if include_optional:
            return AnalyticObjectDTO(
                ...
                id = '',
                object_references = [
                    visier.api.model_query.models.object_reference_dto.ObjectReferenceDTO(
                        description = '', 
                        display_name = '', 
                        from_object = '', 
                        id = '', 
                ...
                population_configuration = visier.api.model_query.models.population_configuration_dto.PopulationConfigurationDTO(
                    change_history_properties = [
                        visier.api.model_query.models.property_reference_dto.PropertyReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], 
                    ...
                    grouping_dimensions = [
                        visier.api.model_query.models.dimension_reference_dto.DimensionReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], ),
                property_ids = [
