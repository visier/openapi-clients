        ...
        if include_optional:
            return DataVersionExportsDTO(
                data_version_exports = [
                    visier.api.data_version_export.models.data_version_export_dto.DataVersionExportDTO(
                        ...
                        tables = [
                            visier.api.data_version_export.models.data_version_export_table_dto.DataVersionExportTableDTO(
                                common_columns = null, 
                                deleted_columns = [
                                    ''
                                    ], 
