...
from visier.api.system_status.api_client import ApiClient, RequestSerialized
from visier.api.system_status.api_response import ApiResponse
from visier.api.system_status.rest import RESTResponseType
...
class SystemStatusApi:
    ...
    @validate_call
    def get_system_status_system_status(
        self,
        ...
        _param = self._get_system_status_system_status_serialize(
    ...
    @validate_call
    def get_system_status_system_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_system_status_system_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_system_status_system_status_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def post_system_status_system_status(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._post_system_status_system_status_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_system_status_system_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def post_system_status_system_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _post_system_status_system_status_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
