    ...
    def make_instance(self, include_optional) -> TenantDataUploadsListResponseDTO:
        ...
        if include_optional:
            return TenantDataUploadsListResponseDTO(
                ...
                start = 56,
                tenants = [
                    visier.api.data_handling.models.tenant_data_uploads_response_dto.TenantDataUploadsResponseDTO(
                        tenant_code = '', 
                        uploads = [
                            visier.api.data_handling.models.tenant_data_upload_status_response_dto.TenantDataUploadStatusResponseDTO(
                                included = True, 
                                upload_time = '', )
                            ], )
                    ]
