    ...
    def make_instance(self, include_optional) -> AssignConnectorWithCredentialsResponseDTO:
        ...
        if include_optional:
            return AssignConnectorWithCredentialsResponseDTO(
                connector = visier.api.data_handling.models.connector_info_response_dto.ConnectorInfoResponseDTO(
                    connector_id = '', 
                    description = '', 
                    display_name = '', ),
                credential = visier.api.data_handling.models.assigned_credential_info_response_dto.AssignedCredentialInfoResponseDTO(
                    credential_id = '', 
                    display_name = '', 
                    message = '', )
            )
