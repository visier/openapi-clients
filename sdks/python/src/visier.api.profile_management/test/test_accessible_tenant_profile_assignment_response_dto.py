    ...
    def make_instance(self, include_optional) -> AccessibleTenantProfileAssignmentResponseDTO:
        ...
        if include_optional:
            return AccessibleTenantProfileAssignmentResponseDTO(
                bad_tenant_codes = [
                    visier.api.profile_management.models.tenant_code_error_dto.TenantCodeErrorDTO(
                        error = null, 
                        for_all_children = True, 
                        tenant_code = '', )
                    ],
                bad_user_ids = [
                    visier.api.profile_management.models.user_id_error_dto.UserIdErrorDTO(
                        error = null, 
                        user_id = '', )
                    ],
                errors = True,
                failed_assignments = [
                    visier.api.profile_management.models.failed_accessible_tenant_profile_assignment_dto.FailedAccessibleTenantProfileAssignmentDTO(
                        error = null, 
                        for_all_children = True, 
                        tenant_code = '', 
                        user_id = '', )
                ...
                successful_assignments = [
                    visier.api.profile_management.models.successful_accessible_tenant_profile_assignment_dto.SuccessfulAccessibleTenantProfileAssignmentDTO(
                        for_all_children = True, 
                        tenant_code = '', 
                        user_id = '', )
                    ]
