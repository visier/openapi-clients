    ...
    def make_instance(self, include_optional) -> AggregationQueryExecutionDTO:
        ...
        if include_optional:
            return AggregationQueryExecutionDTO(
                query = visier.model_query.models.aggregation_query_dto.AggregationQueryDTO(
                    source = null, 
                    filters = [
                ...
                options = visier.model_query.models.query_execution_options_dto.QueryExecutionOptionsDTO(
                    calendar_type = 56, 
