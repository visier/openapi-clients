    ...
    def make_instance(self, include_optional) -> AnalyticObjectDTO:
        ...
        if include_optional:
            return AnalyticObjectDTO(
                ...
                object_references = [
                    visier.model_query.models.object_reference_dto.ObjectReferenceDTO(
                        id = '', 
                        display_name = '', 
                        description = '', 
                        from_object = '', 
                ...
                population_configuration = visier.model_query.models.population_configuration_dto.PopulationConfigurationDTO(
                    distinguishing_properties = [
                        visier.model_query.models.property_reference_dto.PropertyReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], 
                    ...
                    grouping_dimensions = [
                        visier.model_query.models.dimension_reference_dto.DimensionReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], )
            )
