    ...
    def make_instance(self, include_optional) -> AggregationQuerySourceDTO:
        ...
        if include_optional:
            return AggregationQuerySourceDTO(
                formula = '',
                metric = '',
                metrics = visier.model_query.models.aggregation_query_source_metrics_dto.AggregationQuerySourceMetricsDTO(
                    columns = [
                        visier.model_query.models.aggregation_query_source_metric_dto.AggregationQuerySourceMetricDTO(
                            column_name = '', 
                            id = '', 
                            formula = '', 
                            qualifying_path = '', )
