...
**zero_visibility** | **int** | Show or hide zeros in the result. Default is SHOW. | [optional] 
**null_visibility** | **int** | Show or hide null or N/A values in the result. Default is SHOW. | [optional] 
**cell_distribution_options** | [**CellDistributionOptionsDTO**](CellDistributionOptionsDTO.md) |  | [optional] 
**axis_visibility** | **int** | The amount of information to return about each axis. Default is SIMPLE. | [optional] 
