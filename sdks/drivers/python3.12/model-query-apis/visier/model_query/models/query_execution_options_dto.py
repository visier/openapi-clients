...
class QueryExecutionOptionsDTO(BaseModel):
    ...
    zero_visibility: Optional[StrictInt] = Field(default=None, description="Show or hide zeros in the result. Default is SHOW.", alias="zeroVisibility")
    null_visibility: Optional[StrictInt] = Field(default=None, description="Show or hide null or N/A values in the result. Default is SHOW.", alias="nullVisibility")
    cell_distribution_options: Optional[CellDistributionOptionsDTO] = Field(default=None, alias="cellDistributionOptions")
    axis_visibility: Optional[StrictInt] = Field(default=None, description="The amount of information to return about each axis. Default is SIMPLE.", alias="axisVisibility")
