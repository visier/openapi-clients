...
class QueryAxisDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["formula", "selectionConcept", "dimensionMemberSelection", "memberMapSelection", "numericRanges", "dimensionLevelSelection", "dimensionLeafMemberSelection", "dimensionDataMemberSelection", "tableAxisOptions"]
