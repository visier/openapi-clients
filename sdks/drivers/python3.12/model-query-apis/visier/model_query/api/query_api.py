...
from visier.model_query.api_client import ApiClient, RequestSerialized
from visier.model_query.api_response import ApiResponse
from visier.model_query.rest import RESTResponseType
...
class QueryApi:
    ...
    def query_aggregate(
        ...
        _param = self._query_aggregate_serialize(
    ...
    @validate_call
    def query_aggregate_with_http_info(
        self,
        aggregation_query_execution_dto: AggregationQueryExecutionDTO,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def query_aggregate_without_preload_content(
        self,
        aggregation_query_execution_dto: AggregationQueryExecutionDTO,
        _request_timeout: Union[
            None,
    ...
    def _query_aggregate_serialize(
        self,
    ...
    def query_list(
        ...
        _param = self._query_list_serialize(
    ...
    @validate_call
    def query_list_without_preload_content(
        self,
        list_query_execution_dto: ListQueryExecutionDTO,
        _request_timeout: Union[
            None,
    ...
    def query_sql_like(
        ...
        _param = self._query_sql_like_serialize(
    ...
    @validate_call
    def query_sql_like_with_http_info(
        self,
        sql_like_query_execution_dto: SqlLikeQueryExecutionDTO,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def query_sql_like_without_preload_content(
        self,
        sql_like_query_execution_dto: SqlLikeQueryExecutionDTO,
        _request_timeout: Union[
            None,
